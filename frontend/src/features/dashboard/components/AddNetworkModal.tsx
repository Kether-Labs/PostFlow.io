                ...
                <>
                    ...
                    >
                        ...
                        <p className="text-sm text-slate-600 mb-6">
                            ...
                            <a href="#" className="font-semibold text-[#7B51FA] hover:underline">Suivre notre guide</a>
                            {" "}ou{" "}
                            <a href="#" className="font-semibold text-[#7B51FA] hover:underline">Contacter le support</a>.
                        </p>
                            ...
                            {networks.map((network) => (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`flex h-10 w-10 items-center justify-center rounded-full ${network.logoColor} text-white font-bold text-lg shadow-sm group-hover:scale-105 transition-transform`}>
                                            {network.letter}
                                        </div>
                                        <div className="flex flex-col">
                                            <div className="flex items-center gap-1.5">
                                                <span className="font-bold text-slate-800">{network.name}</span>
                                                {network.subtitle && (
                                                    <span className="text-xs text-gray-400 font-medium">{network.subtitle}</span>
                                                )}
                                                {network.connected && (
                                            ...
                                            {network.description && (
                                                <span className="text-xs text-slate-500 mt-0.5">{network.description}</span>
                                            )}
                                        </div>
                                    </div>
