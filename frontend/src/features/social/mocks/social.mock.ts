...
export const mockFacebookAccount: SocialAccount = {
  ...
  name: 'PostFlow',
  avatar:
    'https://ui-avatars.com/api/?name=PostFlow&background=1877F2&color=fff',
  status: 'CONNECTED',
...
export const mockLinkedInAccount: SocialAccount = {
  ...
  name: mockUser.name,
  avatar:
    'https://ui-avatars.com/api/?name=PostFlow&background=0A66C2&color=fff',
  status: 'CONNECTED',
  connectedAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
  expiresAt: new Date(Date.now() + 53 * 24 * 60 * 60 * 1000).toISOString(),
}
...
export const mockConnectFacebookResponse: ConnectSocialAccountResponse = {
  success: true,
  redirectUrl:
    'https://www.facebook.com/v18.0/dialog/oauth?mock=true&platform=facebook',
}
...
export const mockConnectLinkedInResponse: ConnectSocialAccountResponse = {
  success: true,
  redirectUrl:
    'https://www.linkedin.com/oauth/v2/authorization?mock=true&platform=linkedin',
}
